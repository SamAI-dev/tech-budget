      ...
      <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <header className="mb-8">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex hflex size-16 items-center justify-center rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 text-4xl           {post.image}
            </div>
        ...
        <div className="mt-12 rounded-2xl bg-white p-6 shadow-md">
          ...
          <div className="flex gap-4">
            <button className="flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 transition-colors">
              <svg className="h-5 w-size-5="currentColor" viewBox="0 0 24 24">
